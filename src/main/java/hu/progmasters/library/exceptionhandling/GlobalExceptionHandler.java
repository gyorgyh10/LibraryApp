...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<List<ValidationError>> handleUserHasActiveBorrowings(
            UserHasActiveBorrowingsException exception) {
        ValidationError validationError = new ValidationError("userId",
    ...
    public ResponseEntity<List<ValidationError>> handleExemplarIsInActiveBorrowing(
            ExemplarIsInActiveBorrowingException exception) {
        ValidationError validationError = new ValidationError("exemplarId",
                "Exemplar with id " + exception.getExemplarId() +
                        " is in activ borrowing. Can't be deleted!");
        return new ResponseEntity<>(List.of(validationError), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(BorrowingTimeHasExpiredException.class)
    public ResponseEntity<List<ValidationError>> handleBorrowingTimeHasExpired(
            BorrowingTimeHasExpiredException exception) {
        ValidationError validationError = new ValidationError("borrowingId",
                "Borrowing with id " + exception.getBorrowingId() +
